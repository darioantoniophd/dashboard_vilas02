...
my_data$`A10R` = 100/(1+1600/my_data$`A10 (600s+CT) [Pa]`)
...
selectInput("plot_type", "Select plot type:", choices = c('scatter_A_vs_Prueba','scatter_A_vs_Medicion','boxplot_por_prueba','boxplot_por_muestra','scatter_A_vs_Pmed','scatter_A_vs_Pruptura','sigma_A_por_prueba'), multiple = FALSE,selected ='scatter')

# Date range input widgets
dateRangeInput("date_range", "Select date range:", 
                 start = as.Date("2022-11-30"), end = Sys.Date(), 
