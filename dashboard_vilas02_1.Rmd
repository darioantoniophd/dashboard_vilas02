...
my_data$Tamb_i = as.numeric(as.character(my_data$Tamb_i))
my_data$Tamb_f = as.numeric(as.character(my_data$Tamb_f))
my_data$deltaTamb = my_data$Tamb_f-my_data$Tamb_i
...
my_data_QC$Problema[abs(my_data_QC$deltaTamb) > config$deltaTamb_max] <- 'deltaTamb_Alto'
...
selectInput("y_var", "Select Y axis variable:", choices = c('A1','A5','A10','A10R','A20','MCF','CT','Amplitud_base','P_canal_abierto_QC2','QC3minusQC1','P_canal_cerrado_QC1','P_desprendimiento','deltaPmed','Alpha','Tamb_i','Tamb_f','deltaTamb'), multiple = FALSE, selected ='A10')
selectInput("x_var", "Select X axis variable:", choices = c('Prueba','Medicion','deltaPmed','Muestra','Forma_curva','Nro_Cartucho','Fecha','P_canal_abierto_QC2','QC3minusQC1','P_canal_cerrado_QC1','P_desprendimiento','Amplitud_base','CT','A10','Tamb_i','Tamb_f','deltaTamb'), multiple = FALSE, selected ='Prueba')
