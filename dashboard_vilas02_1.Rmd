...
* El CT también podría tener una correlación con el deltaPmed, aunque esto no se ve claramente en los datos.
...
### Planificación
* Hacer seguimiento del deltaPmed y CT cuando se corrija el control de temperatura.
* Evaluar el efecto de la mayor variabildiad de la presion de base sobre la repetibilidad
