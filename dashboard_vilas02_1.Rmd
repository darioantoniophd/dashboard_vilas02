...
config = yaml.load_file("/home/dario/Dropbox/MZP/desarrollo/vilas02_pruebas/R/vilas02git/config.yml")
...
ggplot(midata, aes(x = .data[[x_col]], y = .data[[a_col]], color = .data[[color_col]])) +
  ...
  geom_text(data = cv_data, aes(x = .data[[x_col]], y = min(midata[[a_col]]), label = paste0("", round(cv,0), "%")), vjust = 1, angle = 55, size = 3, color = "blue", nudge_x = -0.2)
...
dateRangeInput("date_range", "Select date range:", 
                 start = as.Date("2023-06-01"), end = Sys.Date(), 
