...
my_data <- my_data %>%
  mutate(
    ...
    A10corregido = (A10 * P_canal_cerrado_QC1)/(cte*P_canal_cerrado_QC1-A10),
...
cat_variables <- sort(c('Prueba','Activacion','Muestra','Comportamiento_curva_pmed','Nro_Cartucho','Picos_curva_pmed','Pasa_criterio_fase','Resultado','Medicion','Fecha','Problema','Sujeto'))
