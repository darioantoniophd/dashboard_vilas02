...
selectInput("values_freq", "Select values for Frequency:", choices = unique(my_data$Frecuencia), multiple = TRUE, selected = '1')
...
selectInput("problemas","Show Failed: ", choices = c('Failed','Good','Good_and_failed'), multiple = FALSE,selected ='Good')
