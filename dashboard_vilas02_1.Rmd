...
my_data_QC$Problema[my_data_QC$Pmed_base < config$pbase_min] <- 'QC_failed_Pbase'
...
selectInput("x_var", "Select X axis variable:", choices = c('Prueba','Medicion','deltaPmed','Muestra','Forma_curva','Nro_Cartucho','Fecha','P_canal_abierto_QC2','P_canal_cerrado_QC1','P_desprendimiento','Amplitud_base','CT','A10'), multiple = FALSE, selected ='Prueba')
