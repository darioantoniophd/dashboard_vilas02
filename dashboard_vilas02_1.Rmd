...
selectInput("plot_type", "Select plot type:", choices = c('scatter','boxplot','boxplot_sd'), multiple = FALSE,selected =config$plot_type)
...
pvn_data <- subset(my_data_QC_sin_problema, Muestra == "PVN")
