...
my_data$A10R = AtoAR(my_data$A10)
...
my_data$deltaCC = my_data$P_canal_cerrado_QC3-my_data$P_canal_cerrado_QC1
...
cte=0.1
my_data$A10corregido <- 3*(my_data$A10 *cte* my_data$P_canal_cerrado_QC3)/(my_data$A10 + cte*my_data$P_canal_cerrado_QC3)
#my_data$A10corregido <- (my_data$A10 )/(my_data$P_canal_cerrado_QC3)

my_data$A10Rcorregido <- AtoAR(my_data$A10corregido)
...
my_palette <- c("#FF0000", "#00FF00", "#0000FF", "#FF00FF", "#00FFFF", "#FFFF00",
 ...
 if (plot_type == "scatter") {
  ...
  ggplot(midata, aes(x = .data[[x_col]], y = .data[[a_col]], color = .data[[color_col]], shape = .data[[shape_col]])) +
    ...
    theme_bw() +
    theme(axis.text.x = element_text(angle = 90, vjust = 0.5,size = 14),axis.text.y = element_text(size = 14))+
     # Add vertical lines 
   if (x_col=='Prueba') {
...
selectInput("y_var", "Select Y axis variable:", choices = c('A1','A5','A10','A10R','A20','MCF','CT','Amplitud_base','P_canal_abierto_QC2','deltaCC','P_canal_cerrado_QC1','P_canal_cerrado_QC3','P_desprendimiento','Pmed_base','deltaPmed','Alpha','Tz_i','Tz_A10','deltaTz','A10corregido','A10Rcorregido'), multiple = FALSE, selected ='A10')
selectInput("x_var", "Select X axis variable:", choices = c('Prueba','Medicion','deltaPmed','Muestra','Forma_curva','Nro_Cartucho','Fecha','P_canal_abierto_QC2','deltaCC','P_canal_cerrado_QC1','P_canal_cerrado_QC3','P_desprendimiento','Pmed_base','Amplitud_base','CT','A10','Tz_i','Tz_A10','deltaTz'), multiple = FALSE, selected ='Prueba')
