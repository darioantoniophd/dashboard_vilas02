...
my_data$Forma_curva <- as.character(my_data$`Forma curva amplitud cruda`)
...
selectInput("values_freq", "Select values for Frequency:", choices = unique(subset_data$Frecuencia), multiple = TRUE, selected = unique(subset_data$Frecuencia))
...
selectInput("color_var", "Select color variable:", choices = c('Prueba','Activacion','Muestra','Forma_curva','Nro_Cartucho','Saltos_curva_pmed','Picos_curva_pmed'), multiple = FALSE, selected ='Activacion')

selectInput("shape_var", "Select shape variable:", choices = c('Prueba','Activacion','Muestra','Forma_curva','Nro_Cartucho'), multiple = FALSE, selected ='Activacion')
