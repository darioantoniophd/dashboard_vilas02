...
my_data$Pmed_base = as.numeric(as.character(my_data$Pmedia))
my_data$Pmed_A10 = as.numeric(as.character(my_data$Pmax))
my_data$`A10 (600s+CT) [Pa]` = as.numeric(as.character(my_data$`A10 [Pa]`))
...
subset_data <- subset(subset_data, `Capilar`=="Capi. CH")
...
save(subset_data, file = "subset_data.Rdata")
